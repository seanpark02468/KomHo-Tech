...
const I18nEngine = {
  ...
  ui: {
    ko: {
      "nav-logo-text": "미식지니",
      "hero-title": "나의 여행 <span class=\"highlight-text\">MBTI</span>에 맞는<br>부산 최고의 맛집을 지도로",
      "hero-subtitle": "부산 미식투어 공공데이터와 여행 성향 퀴즈를 결합하여<br>당신의 취향을 저격하는 1:1 커스텀 맛집 큐레이션 지도를 그려드립니다.",
      "start-quiz-btn": "미식 성향 퀴즈 시작하기 <i class=\"fas fa-arrow-right\"></i>",
      "quiz-badge": "성향 분석 퀴즈",
      "loading-title": "당신의 취향 맵을 분석 중입니다...",
      "loading-subtitle": "부산 공공데이터 식당의 텍스트와 취향 매칭도를 분석하여 정밀 정렬을 수행하고 있습니다.",
    ...
    en: {
      "nav-logo-text": "Foodie Genie",
      "hero-title": "Busan's Best Food on a Map<br>tailored to your Travel <span class=\"highlight-text\">MBTI</span>",
      "hero-subtitle": "Combining Busan gastronomy public API data with a travel personality quiz<br>to draw a 1:1 custom curated food map just for you.",
      "start-quiz-btn": "Start Gastronomy Quiz <i class=\"fas fa-arrow-right\"></i>",
      "quiz-badge": "Travel MBTI Quiz",
      "loading-title": "Analyzing your taste map...",
      "loading-subtitle": "Analyzing keyword match scores with Busan public data restaurants to rank recommendations.",
